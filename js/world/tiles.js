...
// 'C' = parede de igreja (prédio religioso real, não decorativo).
export const SOLIDS = new Set(['t', 'r', 'w', 'h', 'v', 'q', 'l', 'k', 'o', 'T', 'C']);
...
// 'I' = piso interno de igreja · 'E' = entrada aberta de igreja (caminhável).
export const WALK_SPAWN = new Set(['g', 'p', 'y', 'c', 'f', 'z', 'b', 'x', 's', 'd', 'n', 'I', 'E']);
